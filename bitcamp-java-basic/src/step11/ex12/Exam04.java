...
public class Exam04 {
    public static void main(String[] args) {
        ...
        // 비록 m1과 m2는 같은 값을 같고 있지만 인스턴스가 다르다.
        System.out.println(m1 == m2);
        
        // Object로부터 받은 상속 받은 hashCode()는 인스턴스 마다 고유의 해시값을 리턴한다.
        System.out.printf("%x, %x\n", m1.hashCode(), m2.hashCode());
        
        // Object로부터 상속 받은 toString()은 "클래스명@해쉬값"을 리턴한다.
        ...
        // 비록 s1과 s2는 같은 값을 같고 있지만 인스턴스가 다르다.
        System.out.println(s1 == s2);
        
        // String 클래스는 Object로부터 받은 상속 받은 hashCode()를 오버라이딩 했다.
