...
public class Exam02_2 {
    public static void main(String[] args) {
        ...
        //    이렇게 객체안에 값을 넣어 포장한다고 해서 "오토 박싱" 이라 부른다.
        Integer obj3 = i1; // 내부적으로 new Integer(i1)으로 바뀐다.
                           // 즉 int 값이 obj3에 저장되는것이 아니라,
                           // 내부적으로 Integer 객체가 생성되어 그 주소가 저장된다.
        
        // => auto-unboxing
        //    Integer 객쳉레서 값을 꺼내 리턴한다.
        //    이렇게 객체 안에 들어있는 값을 자동으로 꺼낸다고 해서 "오토 언박싱"이라고 부른다.
        Integer obj4 = new Integer(300);
        int i3 = obj4; // 내부적으로 obj4.intValue()로  바뀐다.
                       // 즉 obj4에 들어 있는 인스턴스 주소가 i3저장되는 것이 아니라,
