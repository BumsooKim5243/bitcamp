...
public class App {
    ...
    public static void main(String[] args) {
        ...
        prepareTestData(teamDao, teamMemberDao);
        ...
        TeamMemberController teamMemberController = new TeamMemberController(keyScan, teamDao,
    ...
    static void prepareTestData(TeamDao teamDao,TeamMemberDao teamMeberDao) {
            Team team = new Team();
            team.setName("t1");
            team.setMaxQty(5);
            team.setStartDate(Date.valueOf("2018-1-1"));
            team.setEndDate(Date.valueOf("2018-5-30"));
            teamMeberDao.addMember("t1", "aaa");
            teamMeberDao.addMember("t1", "bbb");
            teamMeberDao.addMember("t1", "ccc");
            teamDao.insert(team);
            ...
            teamMeberDao.addMember("t2", "ccc");
            teamMeberDao.addMember("t2", "ddd");
            teamMeberDao.addMember("t2", "eee");
            teamDao.insert(team);
    }
}
