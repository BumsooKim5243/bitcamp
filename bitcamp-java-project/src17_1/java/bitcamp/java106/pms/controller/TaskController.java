...
public class TaskController {
    ...
    private void onTaskState(final Team team) {
        ...
        System.out.printf("'%s' 작업의 상태: %s\n", task.getTitle(), getStateLaber(task.getState()));
        
        
        System.out.print("변경할 상태는? (0:작업대기, 1:작업중, 9:작업완료)");
    ...
    public static String getStateLaber(int state) {
        switch (state) {
