...
public class Exam01 extends HttpServlet {
    ...
    protected void doGet(
        ...
        out.println("그리고 세션의 아이디를 쿠키를 보냈습니다.");
        
// 세션 생성
// - getSession()을 호출하면,
// - 우선 웹브라우저가 보낸 쿠키중에서 세션 아이디가 있는지 확인한다.
// - 만약 없다면 새 세션(HttpSession)을 생성한 후 그 세션 객체를 리턴한다.
// - 응답할 때 새로 생성한 세션 객체의 아이디를 웹브라우저로 쿠키에 담아 전달한다.
//
// - Http 응답 프로토콜 예:
//        HTTP/1.1 200
//        Set-Cookie: JSESSIONID=B90B17B77AB9702560373A46415E22C1; Path=/bitcamp-web01; HttpOnly
//        Content-Type: text/plain;charset=UTF-8
//        Content-Length: 117
//        Date: Wed, 23 May 2018 05:35:14 GMT
